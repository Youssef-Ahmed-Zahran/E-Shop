...
import { useUpdateSupplier } from "../../slice/supplierSlice";
...
function EditSupplier({ isOpen, onClose, supplier }) {
  const [formData, setFormData] = useState(initialFormData);
  const updateSupplier = useUpdateSupplier();

  // Sync form data when supplier changes
  useEffect(() => {
    if (supplier) {
      setFormData({
        name: supplier.name || "",
